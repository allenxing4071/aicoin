...
class IntelligenceStorage:
    """Store and retrieve intelligence reports in Redis"""
    ...
    async def store_report(self, report: IntelligenceReport) -> bool:
        ...
        try:
            ...
            # Update latest pointer (no expiration for the pointer)
            ...
            logger.info(f"✅ 存储情报报告成功: {report.timestamp}")
            return True
    ...
    async def get_latest_report(self) -> Optional[IntelligenceReport]:
        ...
        try:
            ...
            report = IntelligenceReport.from_dict(report_data)
    ...
    async def get_report_history(self, limit: int = 10) -> List[IntelligenceReport]:
        ...
        try:
            ...
            for key in report_keys:
                ...
                if report_data:
                    reports.append(IntelligenceReport.from_dict(report_data))
    ...
    async def get_report_by_timestamp(self, timestamp: datetime) -> Optional[IntelligenceReport]:
        ...
        try:
            ...
            return IntelligenceReport.from_dict(report_data)
