"""Baidu Qwen Search Adapter - 百度智能云Qwen联网搜索适配器"""
...
class BaiduQwenAdapter(BasePlatformAdapter):
    ...
    async def analyze(
        ...
        try:
            ...
            logger.info(f"✅ 百度智能云搜索完成: {len(key_findings)} 个关键发现")
            return result
