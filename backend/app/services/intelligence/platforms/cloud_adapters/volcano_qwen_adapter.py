"""Volcano Qwen Search Adapter - 火山引擎Qwen联网搜索适配器"""
...
class VolcanoQwenAdapter(BasePlatformAdapter):
    """
    火山引擎 - Qwen联网搜索适配器
    
    职责：
    1. 使用火山引擎（字节跳动）提供的Qwen模型联网搜索能力
    2. 获取最新的市场新闻动态
    3. 查找官方公告和监管信息
    ...
    async def analyze(
        ...
        try:
            ...
            logger.info(f"✅ 火山引擎搜索完成: {len(key_findings)} 个关键发现")
            return result
