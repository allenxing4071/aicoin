...
class QwenDecisionEngine:
    ...
    def __init__(self, redis_client: RedisClient):
        ...
        self.risk_tolerance = 0.015  # 风险容忍度 1.5%
...
"""
    ...
    async def _record_decision(self, decision: Dict[str, Any]):
        ...
        try:
            ...
            logger.info(f"Qwen decision recorded: {decision_id}")
    ...
    async def optimize_decision(self, decision: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if risk_level == 'low':
                optimized_position = min(base_position * 1.1, self.max_position_size)
            elif risk_level == 'high':
                optimized_position = max(base_position * 0.6, 50)
            else:
