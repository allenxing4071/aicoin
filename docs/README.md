...
### 02-部署运维
- **[快速部署](02-部署运维/快速部署.md)** - Docker/本地/远程/测试网/主网
- **[配置指南](02-部署运维/配置指南.md)** - 环境变量/AI平台/交易所/权限
- **[运维操作](02-部署运维/运维操作.md)** - 监控/备份/日志/版本管理
- **[故障排查](02-部署运维/故障排查.md)** - 常见问题诊断与解决

### 03-开发文档
- **[系统架构](03-开发文档/系统架构.md)** - 完整技术架构
  - 整体架构
...
### 👤 新手用户
1. [快速开始](快速开始.md) - 5分钟部署
2. [用户指南](01-用户指南/用户指南.md) - 核心概念
3. [故障排查](02-部署运维/故障排查.md) - 常见问题

### 💼 产品经理
1. [用户指南](01-用户指南/用户指南.md) - 功能说明
2. [系统架构](03-开发文档/系统架构.md) - 技术架构
3. [研究报告](03-开发文档/研究报告/) - 策略研究

### 👨‍💻 开发人员
1. [系统架构](03-开发文档/系统架构.md) - 技术架构
2. [API文档](03-开发文档/API接口/) - API接口
3. [前端文档](03-开发文档/前端文档/) - 前端开发

### 🔧 运维人员
1. [快速部署](02-部署运维/快速部署.md) - 部署指南
2. [配置指南](02-部署运维/配置指南.md) - 配置说明
3. [运维操作](02-部署运维/运维操作.md) - 日常运维
4. [故障排查](02-部署运维/故障排查.md) - 问题诊断
